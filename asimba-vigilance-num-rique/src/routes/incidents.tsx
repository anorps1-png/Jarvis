          ...
          <Card className="shadow-elev-1">
            ...
            <div className="divide-y divide-border">
              {list.map((a, i) => (
                <button
                  key={a.id}
                  className={`w-full text-left px-4 py-3 hover:bg-muted/40 transition-colors ${i === 0 ? "bg-primary/5" : ""}`}
                >
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-[12.5px] text-muted-foreground">
                    Publié sur {incident.source} · Signalé par un citoyen · Détecté le{" "}
                    {formatDateTime(incident.detecte)}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {incident.motsCles.map((m) => (
                      <Badge key={m} variant="secondary" className="rounded-md text-[11px]">
                        {m}
                      </Badge>
                    ))}
                  </div>
                ...
                <ol className="relative border-l border-border pl-5 space-y-4">
                  {[
                    { t: "12:04", who: "Système", txt: "Contenu ingéré depuis Facebook Graph API" },
                    {
                      t: "12:04",
                      who: "ASIMBA-AI",
                      txt: "Score de risque calculé : 92/100 (critique)",
                    },
                    ...
                    <li key={i} className="relative">
                      ...
                      <div className="text-[13px]">
                        <span className="font-medium">{e.who}</span> · {e.txt}
                      </div>
                    </li>
                  ))}
                </ol>
                ...
                {[
                  {
                    ...
                    t: "il y a 12 min",
                    txt: "Vérification en cours avec la BSC. Le compte source est actif depuis 2023 et a déjà été signalé.",
                  },
                  {
                    who: "S. Ekambi",
                    role: "Analyste",
                    t: "il y a 6 min",
                    txt: "Classification confirmée. Deux comptes relais identifiés, à surveiller.",
                  },
                ].map((c, i) => (
